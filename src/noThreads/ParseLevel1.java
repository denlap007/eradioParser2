...
public class ParseLevel1 {
    ...
    private final int WEIGHT_IN_COMPUTATION = 30;
    private ProgressState curProgress;

    public ParseLevel1(ProgressState curProgress) {
    ...
    public void getFirstLinks(ArrayList<Integer> theCodes) throws IOException {
        ...
        for (int code : theCodes) {
            ...
            num = (float) (theCodes.indexOf(code)) / (float) (theCodes.size()) * WEIGHT_IN_COMPUTATION;
            curProgress.setCurProgress((int) num);
            //System.out.println("Current progress: "+(int)num);
        }//end outer for		
